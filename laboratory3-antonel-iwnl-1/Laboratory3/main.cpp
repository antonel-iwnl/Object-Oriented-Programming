...
int main(int argc, char** argv) {
	...
	cout << "Multiply complex numbers= " << complex_multiply(*c1, c).real << " + " << complex_multiply(*c1, c).image << "i" << endl;
	cout << "subtract complex numbers= " << complex_subtract(*c1, c).real << " + " << complex_subtract(*c1, c).image << "i" << endl;
	cout << "Divide complex numbers= " << complex_division(*c1, c).real << " + " << complex_division(*c1, c).image << "i" << endl;
	delete c1;
	return 0;
}
